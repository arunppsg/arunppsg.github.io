...
Digital communication tools encourages intreactions through short, text-based messages and approval clicks that are orders of magnitude less information laden that what we have evolved to expect.
...
<!--
A whatsapp message uses less brain than a direct inperson communication as the latter involved identifying social cues.
An average person spends .. hours per day/week/month in social media and in Facebook's product alone -- hours.

When Steve Jobs first introduced the iPhone, it was a device which could make calls, listen to music and has internet connection.

Contrary to the popular view, the Amish are excellent hackers and they use sophisticated technology.
The Amish has a clear intention on how they are going to use a technology.

Why is it hard to stay away from digital world?
Because companies spend billions of dollars to find ways on how our attention can be hijacked.
Simply saying that I will not use social media today will not work.

Why do people take photos?
People take photos as our brain has a need to do something.
When we take a photo and post it online, we recieve social validation.


What leisure activities can I pick up?
What is Walden?
Mor Money Mustache

When you reintroduce them, have an intentional use on how you are going to use it.
By this, for each technology, use it in a way which adds to you the most value.
